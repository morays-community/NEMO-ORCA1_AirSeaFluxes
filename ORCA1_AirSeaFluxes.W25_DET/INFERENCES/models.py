...
def W25ann(ux,uy,To,Ta,p,q):
    ...
    if Is_None(ux,uy,To,Ta,p,q):
        ...
        # Keep deterministic part 
        taux, tauy = M_mean*cos.ravel(), M_mean*sin.ravel()
        Qs = SH_mean
        Ql = LH_mean
...
if __name__ == '__main__' :
    ...
    print(f'Inputs -- ux: {ux.shape}, uy: {uy.shape}, Spec.hum: {q.shape}, Toce: {To.shape}, Tair: {Ta.shape}, P: {p.shape}')
