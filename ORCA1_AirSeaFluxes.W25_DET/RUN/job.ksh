...
#SBATCH --job-name=ORCA1_W25_DET      # Job name
...
#SBATCH --output=ORCA1_W25_DET.out    # Name of output listing file
#SBATCH --error=ORCA1_W25_DET.err     # Name of error listing file (the same)
###################################
...
# Post-process
python3 ./compute_yearly_mean.py ORCA1_W25_DET_1y_20000101_20391231_ocebudget.nc ORCA1_W25_DET_40y_ocebudget.nc
python3 ./compute_yearly_mean.py ORCA1_W25_DET_1y_20000101_20391231_ocebudget.nc ORCA1_W25_DET_10y_ocebudget.nc 10
python3 ./compute_monthly_mean.py ORCA1_W25_DET_1m_20000101_20391231_grid_T.nc ORCA1_W25_DET_1m40y_averaged_grid_T.nc
python3 ./compute_monthly_mean.py ORCA1_W25_DET_1m_20000101_20391231_grid_T.nc ORCA1_W25_DET_1m10y_averaged_grid_T.nc 10
