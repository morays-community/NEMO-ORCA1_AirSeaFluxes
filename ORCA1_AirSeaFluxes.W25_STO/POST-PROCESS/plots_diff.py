...
if __name__=="__main__":
    ...
    # SST difference
    infos = [ 'SST (ºC): ORCA1.W25_STO - ORCA1' , cmocean.cm.balance , colors.Normalize(vmin=-2.0, vmax=2.0), lambda x: x ]
    ...
    # QNS difference
    infos = [ 'Non-solar heat flux (W/m2): ORCA1.W25_STO - ORCA1' , cmocean.cm.balance , colors.Normalize(vmin=-40.0, vmax=40.0), lambda x: x ]
    ...
    infos = [ 'MLD_03 (m): ORCA1.W25_STO - ORCA1' , cmocean.cm.balance , colors.Normalize(vmin=-50.0, vmax=50.0), lambda x: x ]
    ...
    infos = [ 'MLD_09 (m): ORCA1.W25_STO - ORCA1' , cmocean.cm.balance , colors.Normalize(vmin=-50.0, vmax=50.0), lambda x: x ]
