...
#if defined key_sto
   CHARACTER(LEN=:), ALLOCATABLE :: numnam_sto_ref  !: character buffer for sto reference namelist
   CHARACTER(LEN=:), ALLOCATABLE :: numnam_sto_cfg  !: character buffer for sto configuration specific namelist
#endif
